...
if __name__ == "__main__":
    """http://adsabs.harvard.edu/abs/2018arXiv180706209P - Planck 2018 sigma_8 values"""
    """sigma_vals = [pv-3error, pv, pv+3error]"""
    sigma_vals = [0.793, 0.811, 0.829]
    make_run(sigma_vals)
